...
const ProjectModal = ({ isOpen, onClose, project }) => {
  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center z-50 bg-black bg-opacity-50 overflow-auto">
      <div className="bg-black text-white rounded-lg overflow-auto w-11/12 sm:w-3/4 md:w-2/3 lg:w-1/2 xl:w-1/3 p-4 md:p-8 relative max-h-screen">
        <button
        ...
        <div className="overflow-y-auto max-h-[70vh]">
          ...
          <div className="flex flex-wrap gap-4 justify-center items-center mb-4">
            <img
              className="w-full md:w-5/12 rounded-md object-cover"
              src={project.image}
              alt={project.title}
            />
            <img
